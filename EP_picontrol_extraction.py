...
forcing = xr.open_mfdataset('/Volumes/Extreme SSD/CMIP_data/ts_Amon_CanESM5_piControl_r1i1p1f1_gn_*.nc')
...
forcing=xr.open_mfdataset('/Volumes/Extreme SSD/CMIP_data/ts_Amon_CMCC-CM2-SR5_piControl_r1i1p1f1_gn_*.nc')
a=int(forcing.sizes['time']/12)
output=regrid_anomaly(forcing,a)
mylist=xr.concat([mylist,output], 'new_dim')
del output
...
forcing1=xr.open_mfdataset('/Volumes/Extreme SSD/CMIP_data/ts_Amon_GFDL-ESM4_piControl_r1i1p1f1_gr1_010101-020012.nc')
...
mylist_mean.to_netcdf('/Users/ullaklintheede/ts_EP_piControl_dim_mean.nc')
