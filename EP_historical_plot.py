...
mylist_OT=xr.open_dataset('/Users/ullaheede_1/Documents/CMIP6_data_rab/ts_EP_historical_dim_mean.nc',decode_cf=False)
...
axlist[0].set_title('EP models mean trend ', fontsize=20)
...
axlist[1].set_title('EP models uniform warming (T$_0$) ', fontsize=20)
...
axlist[2].set_title('EP models mean trend minus T$_0$ ', fontsize=20)
